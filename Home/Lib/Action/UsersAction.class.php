...
class UsersAction extends Action{
    ...
    public function settings(){
		$this->assign("title","飞创教育 - 资料设置");
        $this->display('settings');
    }


    public function avatar(){
		$this->assign("title","飞创教育 - 修改头像");
        $this->display('avatar');
    }
    //定义数据添加的方法
