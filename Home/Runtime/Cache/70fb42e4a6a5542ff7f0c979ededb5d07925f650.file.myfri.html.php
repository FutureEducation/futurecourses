<?php /* Smarty version Smarty-3.1.6, created on 2017-05-02 21:26:47
         compiled from "./Home/Tpl\Message\myfri.html" */ ?>
<?php /*%%SmartyHeaderCode:214855908891734aa69-07652032%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '214855908891734aa69-07652032',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5908891754a6b',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5908891754a6b')) {function content_5908891754a6b($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <title>飞创教育 - 我的关注</title>
    ...
    <div class="container">
        ...
        <div class="col-md-6">
            <ul class="navbar-left">
                <li><a href="__APP__/Message/index">论坛首页</a></li>
                <li class="btn-upload-w"><a href="__APP__/Message/add" class="btn btn-default btn-upload">发帖去~</a></li>
...
<?php }?></a>
                            ...
                            <div style='float:left;width:60px;font:normal 12px "宋体";'>
                                性别:<?php if ($_smarty_tpl->tpl_vars['vo']->value['sex']==''){?>保密<?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['vo']->value['sex']=='1'){?>男<?php }else{ ?>女<?php }?><?php }?>
                            </div>
                            <div style='float:left;width:50px;font:normal 12px "宋体";'>
                                <?php if ($_smarty_tpl->tpl_vars['vo']->value['age']!=''){?>年龄:<?php echo $_smarty_tpl->tpl_vars['vo']->value['age'];?>
<?php }?>
                            </div>
                            <div style='float:left;font:normal 12px "宋体";'>
                                <?php if ($_smarty_tpl->tpl_vars['vo']->value['class']!=''){?>
                                角色:
                                    <?php if ($_smarty_tpl->tpl_vars['vo']->value['class']=='1'){?>
                                        飞创教师
                                    <?php }else{ ?>
                                        飞创学生
                                    <?php }?>
...
?>
                                <?php if ($_smarty_tpl->tpl_vars['ty']->value['id']!=''){?>
