<?php /* Smarty version Smarty-3.1.6, created on 2017-04-30 01:25:45
         compiled from "C:\xampp\htdocs\training\Home\Tpl\Public\head.html" */ ?>
<?php /*%%SmartyHeaderCode:236215904cc99388532-23855819%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6adc493d7d3d92b608b9221da51c9a62733aab0c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\training\\Home\\Tpl\\Public\\head.html',
      1 => 1493459246,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '236215904cc99388532-23855819',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5904cc993e613',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5904cc993e613')) {function content_5904cc993e613($_smarty_tpl) {?><link rel="stylesheet" type="text/css" href="__PUBLIC__/font-awesome/css/font-awesome.min.css">
            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="__APP__/Index/index">Future Education</a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        ...
                        <ul class="nav navbar-nav g_nav">
                            ...
                            <li><a href="__APP__/Note/index">视频手记</a></li>
                            <!--<li><a href="__APP__/Library/index">文库</a></li>-->
                            <li><a href="__APP__/Message/index">交流论坛</a></li>
                            <?php if ($_SESSION['user']){?>
                            <li><a href="__APP__/Test/index">自我检测</a></li>
                            <?php }else{ ?>
                            <li><a href="javascript:alert('请先登录！')">自我检测</a></li>
                            <?php }?>
                            <li><a href="__APP__/Index/feedback">意见反馈</a></li>
                        </ul>
...
"<?php }?> class="avatar_sm">　<?php echo $_SESSION['user']['username'];?>
                                ...
                                <div class="dropdown">
                                    <a href="__APP__/Users/settings"><i class="fa fa-cog"></i>&nbsp;&nbsp;&nbsp;设置</a>
                                    <a href="__APP__/Users/loginout"><i class="fa fa-sign-out"></i>&nbsp;&nbsp;&nbsp;退出</a>
                                </div>
                            </li>
                            <?php }else{ ?>
