<?php /* Smarty version Smarty-3.1.6, created on 2017-04-30 01:25:48
         compiled from "./Home/Tpl\Video\play.html" */ ?>
<?php /*%%SmartyHeaderCode:288755904cc9c783db1-44487626%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '288755904cc9c783db1-44487626',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5904cc9c9395b',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5904cc9c9395b')) {function content_5904cc9c9395b($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\xampp\\htdocs\\training\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
...
" style="position:relative;z-index:100;margin-left:10%;width:750px;height:500px">
                        <div id="a1"></div>
                    </div>
                    ...
                    <div id="playerToolbar" class="clearfix mt20" style="padding:0 100px">
                        <div class="col-md-8 pull-left" style='width:200px;'>
                            <ul class="list_ib">
                                ...
                                <a href="javascript:void(0)" id="favo" idnum="<?php echo $_smarty_tpl->tpl_vars['vo']->value['id'];?>
" title="赞"><?php if ($_smarty_tpl->tpl_vars['iszan']->value){?><font color="red">已赞</font><?php }else{ ?>赞<?php }?></a>
                                ...
                                <li class="v_like">
                                <?php if ($_SESSION['user']){?>
                                <a class="btn-like" id="collect" vidnum="<?php echo $_smarty_tpl->tpl_vars['vo']->value['id'];?>
...
" class="btn btn-sm pull-right btn-primary btn-note-new" target="_blank"><i class="fa fa-pencil"></i>&nbsp;写手记</a>
                            <?php }else{ ?>
...
</a> <i style="float:right">创建日期：<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['n']->value['addtime'],"%Y-%m-%d %H:%M:%S");?>
</i></li>
                        <?php } ?>
