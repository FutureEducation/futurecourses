<?php /* Smarty version Smarty-3.1.6, created on 2017-04-30 01:28:34
         compiled from "./Home/Tpl\Users\login.html" */ ?>
<?php /*%%SmartyHeaderCode:202215904cd424287b4-24142085%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '202215904cd424287b4-24142085',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5904cd424f39b',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5904cd424f39b')) {function content_5904cd424f39b($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse" style="height:50px;line-height:50px">
                        ...
                        <ul class="nav navbar-nav g_nav" style="margin-top:15px">
                            ...
                            <!--<li><a href="__APP__/Library/index">文档库</a></li>-->
                            <li><a href="__APP__/Message/index">交流论坛</a></li>
                            <?php if ($_SESSION['user']){?>
                            <li><a href="__APP__/Test/index">自我测试</a></li>
                            <?php }else{ ?>
                            <li><a href="javascript:alert('请先登录！')">自我测试</a></li>
                            <?php }?>
                        </ul>
...
"<?php }?> class="avatar_sm">　<?php echo $_SESSION['user']['username'];?>
                                ...
                                <div class="dropdown">
                                    <a href="__APP__/Test/index">考试</a>
                                    <a href="__APP__/Users/settings">设置</a>
                                    <a href="__APP__/Users/loginout">退出</a>
                                </div>
                            </li>
                            <?php }else{ ?>
                            <li><a href="__APP__/Index/index"><i class="fa fa-home fa-2x"></i></a></li>
                            <?php }?>
                        </ul>
                    </div>
                </div>
