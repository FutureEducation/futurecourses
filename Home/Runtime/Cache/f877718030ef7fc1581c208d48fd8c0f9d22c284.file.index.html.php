<?php /* Smarty version Smarty-3.1.6, created on 2017-04-30 01:32:11
         compiled from "./Home/Tpl\Note\index.html" */ ?>
<?php /*%%SmartyHeaderCode:23595904ce1b7b2fd2-20276794%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '23595904ce1b7b2fd2-20276794',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5904ce1b86a9a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5904ce1b86a9a')) {function content_5904ce1b86a9a($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\xampp\\htdocs\\training\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_modifier_truncate')) include 'C:\\xampp\\htdocs\\training\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!DOCTYPE html>
<html lang="en">
    <head>
        <title>飞创教育 - 视频手记列表</title>
...
"><?php echo $_smarty_tpl->tpl_vars['vo']->value['username'];?>
                                    ...
                                    <div class="pt5 c999 f12 review_act">
                                        <i class="btn btn-sm btn-default btn-like " data-content_id="35" data-content_type="note"><em><?php echo $_smarty_tpl->tpl_vars['vo']->value['collnum'];?>
</em>人收藏</i>
                                        <i class="btn btn-sm btn-default btn-like " data-content_id="35" data-content_type="note"><em><?php echo $_smarty_tpl->tpl_vars['vo']->value['commnum'];?>
</em>条回复</i>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="col-md-4">
                    ...
                    <div class="biquu_d_placeholder mt50 mb40">
                        <a href=""><img alt="飞创教学网" title="飞创教学网" src="__PUBLIC__/images/0000dh.jpg"></a>
                    </div>
